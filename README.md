...
that ancestor by build number. The first build of a PR keeps the PR body first,
labels the commits as belonging to the pull request, and falls back to all
commits in that PR.
