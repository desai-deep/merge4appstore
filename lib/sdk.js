...
export class ReleaseClient {
  ...
  async status(runId, selection) {
    ...
    return { runId, number: run.attributes.number, progress: run.attributes.executionProgress, completionStatus: run.attributes.completionStatus, commitSha: typeof run.attributes.sourceCommit === 'string' ? run.attributes.sourceCommit : run.attributes.sourceCommit?.commitSha, builds: result };
  }
}
