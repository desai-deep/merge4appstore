...
export const CONFIG = {
  ...
  get webhookHost() { return process.env.WEBHOOK_HOST || '0.0.0.0'; },
  get webhookPort() { return parseInt(process.env.WEBHOOK_PORT || '3000', 10); },
  get webhookPath() {
    const configuredPath = process.env.WEBHOOK_PATH || '/webhooks/xcode-cloud';
    return configuredPath.startsWith('/') ? configuredPath : `/${configuredPath}`;
  },
  get webhookSecretToken() { return process.env.WEBHOOK_SECRET_TOKEN || ''; },
