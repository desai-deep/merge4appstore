...
export const CONFIG = {
  ...
  get appIdentifier() { return process.env.APP_BUNDLE_ID || 'com.deepdesai.runningorder'; },
  get appName() { return process.env.APP_NAME || 'Running Order'; },
  get iosRepoOwner() { return process.env.GITHUB_REPO_OWNER || 'desai-deep'; },
  get iosRepoName() { return process.env.GITHUB_REPO_NAME || 'runningorder-ios'; },
